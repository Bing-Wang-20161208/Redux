                            ...
                            return (
                                <tr key = {item.id} >
                                    ...
                                    <th>
                                        ...
                                        <button onClick={this.props.decrementAsync.bind(this, item.id)}>一秒钟之后再减</button>
                                    </th>
                                    <th></th>
                                </tr>
                            )
...
export default connect(mapStateToProps, { increment, decrement, decrementAsync })(CartList); //connect执行之后才是一个高阶组件